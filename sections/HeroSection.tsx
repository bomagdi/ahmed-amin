      ...
      <div className="lg:basis-2/3 z-10 relative">
        ...
        <div className="overflow-hidden">
          <span className="text-animation text-2xl md:text-3xl lg:text-5xl block md:my-3 text-marrsgreen dark:text-carrigreen font-medium">
            Simplifying finances with expert precision.
          </span>
        </div>
        <div className="mt-2 my-4 md:mb-8">
          <p className="mb-1">
            I offer personalized accounting services, including bookkeeping, tax
            preparation, and financial advice, tailored to meet your individual
            or business needs. With a focus on accuracy and trust, I am here to
